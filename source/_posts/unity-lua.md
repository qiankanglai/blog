...
{% asset_img lua_benchmark/android_1.jpg %}
- 中端设备：红米 Note2 (Android OS 5.0.2)
{% asset_img lua_benchmark/android_2.jpg %}
- 高端设备：三星S6 (Android OS 6.0.1)
{% asset_img lua_benchmark/android_3.jpg %}
...
{% asset_img lua_benchmark/ios_1.jpg %}
- arm64设备：iPhone 5s (OS 9.3.5)
{% asset_img lua_benchmark/ios_2.jpg %}
